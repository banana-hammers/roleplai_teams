...
import type { IdentityCore as OnboardingIdentityCore } from '@/lib/onboarding/generate-identity'
...
// ============================================================================
// Test Drive Prompt Builder
// ============================================================================

/**
 * Build system prompt from identity core for onboarding test-drive chat
 */
export function buildTestDrivePrompt(identity: OnboardingIdentityCore): string {
